...
#
#     def parse(self, response):
#         for stock in response.xpath("//a[@class='lBT6RuJRjtvzChEJ_G30 yDtbhftw9A4mXqH3vPkH ZPgoa_UnfWgowwkvsp64 N9w__d8iYPl6C0KewYiA']"):
#             yield {
#                 'name': stock.xpath(".//div[@class='tJYWSxg23zNUv79hPvVS']/text()").get(),
#                 'risk': stock.xpath(".//span[@class='oiTIR_Sf1_ObNUZhdLv5 mhSVC_KCosmKJ73T2s6O']/text()").get(),
#                 'price': stock.xpath(".//div[@class='JGT__mSaFfXxcOb2oGto']/text()").get()
#             }
